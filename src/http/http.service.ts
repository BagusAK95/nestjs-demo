...
export class HttpService {
  ...
  async delete(url: string, config?: axios.AxiosRequestConfig) {
    return await this.instance.delete(url, config);
  }

  async head(url: string, config?: axios.AxiosRequestConfig) {
    return await this.instance.delete(url, config);
  }

  async post(url: string, data?: any, config?: axios.AxiosRequestConfig) {
    return await this.instance.post(url, data, config);
  }

  async put(url: string, data?: any, config?: axios.AxiosRequestConfig) {
    return await this.instance.put(url, data, config);
  }

  async patch(url: string, data?: any, config?: axios.AxiosRequestConfig) {
